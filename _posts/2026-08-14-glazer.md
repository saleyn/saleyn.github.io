...
[Glazer](https://github.com/saleyn/glazer) is a C++ NIF. It decodes and encodes JSON, YAML, and CSV in a single pass, straight to and from native Erlang terms. No AST. No staging step. No external C++ libraries.
